...
RUN sudo . "$NVM_DIR/nvm.sh" && nvm install ${NODE_VERSION}
RUN sudo . "$NVM_DIR/nvm.sh" && nvm use v${NODE_VERSION}
RUN sudo . "$NVM_DIR/nvm.sh" && nvm alias default v${NODE_VERSION}
